  ...
  try {
    ...
    if(mode==="quoteparts_liste"){
      ...
      var promptFac = "Voici une facture de fournisseur (Quebec, Canada). "
        ...
        + "\"noTPSFournisseur\":\"numero de TPS du fournisseur (format 123456789 RT0001, souvent au bas de la facture)\",\"noTVQFournisseur\":\"numero de TVQ du fournisseur (format 1234567890 TQ0001)\",\"fournisseurRBQ\":\"numero de licence RBQ du fournisseur si visible (important pour les entrepreneurs en construction, format 5678-1234-01)\","
