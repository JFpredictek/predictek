  ...
  try {
    ...
    var anthropicRes = await fetch("https://api.anthropic.com/v1/messages",{
      ...
      body:JSON.stringify({
        ...
        max_tokens:600,
        messages:[{role:"user",content:[{type:"text",text:"Voici le texte extrait d'un document officiel de syndicat de copropriete quebecois:\n\n"+texte.substring(0,8000)+"\n\nExtrait les informations et reponds UNIQUEMENT avec un objet JSON valide sans texte autour. Cles: nom, immat, adr, ville, province, codePostal, nbUnites, gestionnaire. Valeur vide si absent."}]}]
      })
    });
