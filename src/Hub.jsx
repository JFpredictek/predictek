...
function Onboarding(p){
  ...
  var s1=useState({
    ...
    // Etape 1b - Courriels syndicat (deplacÃÂÃÂÃÂÃÂ©s de ÃÂÃÂÃÂÃÂ©tape 2)
      ...
      {step===1&&(
        <div>
          ...
          <div style={{background:"#F0F7FF",border:"1px solid #1A56DB33",borderRadius:10,padding:14,marginBottom:16}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
              <div>
                ...
                <div style={{fontSize:11,color:T.muted}}>Optionnel ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Importez vos PDF pour remplir automatiquement les champs avec l'IA</div>
              </div>
              {(data.reqNom||data.acteNom)&&!iaLoading&&(
                <button onClick={extraireIA} style={{background:"linear-gradient(135deg,#1A56DB,#3CAF6E)",border:"none",borderRadius:8,padding:"8px 16px",color:"#fff",fontSize:12,fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",gap:6}}>
                  <span style={{fontSize:16}}>ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¦</span> Extraire avec l'IA
                </button>
              )}
              {iaLoading&&(
            ...
            {iaSuccess&&(
              <div style={{background:"#E8F2EC",border:"1px solid #1B5E3B44",borderRadius:6,padding:"6px 12px",fontSize:11,color:"#1B5E3B",marginBottom:10,fontWeight:600}}>ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ {iaSuccess}</div>
            )}
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
              ...
              <div style={{background:"#E8F2EC",border:"2px dashed "+(data.acteNom?"#1B5E3B":"#1B5E3B66"),borderRadius:8,padding:12,textAlign:"center",transition:"all 0.2s"}}>
                ...
                <div style={{fontSize:10,color:"#7C7568",marginBottom:8}}>Quorum, annÃÂÃÂÃÂÃÂ©e construction, fractions</div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
            ...
            <Field l="AnnÃÂÃÂÃÂÃÂ©e de construction (dÃÂÃÂÃÂÃÂ©claration)"><input type="number" value={data.anneeConstruction} onChange={function(e){sd("anneeConstruction",e.target.value);}} style={INP} placeholder="2013"/></Field>
            ...
            <Field l="Quorum AGO % (dÃÂÃÂÃÂÃÂ©claration)"><input type="number" min="10" max="75" value={data.quorumAGO} onChange={function(e){sd("quorumAGO",parseInt(e.target.value)||25);}} style={INP}/></Field>
          </div>
          <div style={{background:T.amberL,border:"1px solid "+T.amber+"44",borderRadius:10,padding:14,marginTop:16,marginBottom:4}}>
            <div style={{fontSize:13,fontWeight:700,color:T.amber,marginBottom:6}}>Structure lÃÂÃÂÃÂÃÂ©gale de la copropriÃÂÃÂÃÂÃÂ©tÃÂÃÂÃÂÃÂ©</div>
            <div style={{fontSize:11,color:T.muted,marginBottom:12}}>DÃÂÃÂÃÂÃÂ©terminÃÂÃÂÃÂÃÂ©e par la dÃÂÃÂÃÂÃÂ©claration de copropriÃÂÃÂÃÂÃÂ©tÃÂÃÂÃÂÃÂ© ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ a des impacts juridiques importants sur la gestion</div>
            <div style={{display:"flex",gap:10}}>
              {[
                {v:"horizontale",l:"Horizontale",desc:"UnitÃÂÃÂÃÂÃÂ©s cÃÂÃÂÃÂÃÂ´te ÃÂÃÂÃÂÃÂ  cÃÂÃÂÃÂÃÂ´te (maisons, condos au sol)"},
                {v:"verticale",l:"Verticale",desc:"UnitÃÂÃÂÃÂÃÂ©s superposÃÂÃÂÃÂÃÂ©es (tours, immeubles)"},
      ...
      {step===2&&(
        <div>
          ...
          <div style={{marginBottom:16}}>
            ...
            <div style={{fontSize:11,color:T.muted}}>Nombre impair requis ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ {data.nbMembresCA} administrateur(s) selectionne(s)</div>
          </div>
