...
var PROMPTS={
  req: "Tu es un expert en documents corporatifs quebecois. Analyse cette image du Registre des entreprises du Quebec (REQ) et extrais les informations suivantes en JSON STRICT (aucun texte avant ou apres le JSON):\n{\n  \"type_document\": \"REQ\",\n  \"nom_legal\": \"...\"\n  \"neq\": \"numero 10 chiffres ou null\",\n  \"date_constitution\": \"YYYY-MM-DD ou null\",\n  \"forme_juridique\": \"...\"\n  \"adresse\": \"...\"\n  \"ville\": \"...\"\n  \"province\": \"QC\"\n  \"code_postal\": \"...\"\n  \"administrateurs\": [\n    {\"nom\": \"...\"\n  \"prenom\": \"...\"\n  \"role\": \"president ou administrateur\"\n  \"adresse\": \"...\"}\n  ],\n  \"statut\": \"actif ou autre\",\n  \"date_extraction\": \"aujourd hui\"\n}",

  declaration: "Tu es un expert en copropriete divise au Quebec. Analyse cette image de la Declaration de copropriete et extrais les informations suivantes en JSON STRICT:\n{\n  \"type_document\": \"DECLARATION_COPROPRIETE\",\n  \"nom_syndicat\": \"...\",\n  \"adresse_immeuble\": \"...\",\n  \"ville\": \"...\",\n  \"nb_unites\": 0,\n  \"fractions\": [{\"unite\": \"101\", \"fraction\": 0.025}],\n  \"fonds_prevoyance_pct\": 0,\n  \"quorum_ca\": \"...\",\n  \"quorum_ago\": 0,\n  \"date_acte\": \"YYYY-MM-DD ou null\",\n  \"notaire\": \"...\",\n  \"no_acte\": \"...\",\n  \"regles_principales\": [\"regle 1\", \"regle 2\"]\n}",

  facture: "Tu es un expert-comptable. Analyse cette image de facture et extrais les informations suivantes en JSON STRICT:\n{\n  \"type_document\": \"FACTURE\",\n  \"fournisseur\": \"nom de l entreprise\",\n  \"adresse_fournisseur\": \"...\",\n  \"telephone_fournisseur\": \"...\",\n  \"no_facture\": \"...\",\n  \"date_facture\": \"YYYY-MM-DD\",\n  \"date_echeance\": \"YYYY-MM-DD ou null\",\n  \"description\": \"description generale des services\",\n  \"lignes\": [{\"description\": \"...\", \"quantite\": 1, \"prix_unitaire\": 0.00, \"montant\": 0.00}],\n  \"sous_total\": 0.00,\n  \"tps\": 0.00,\n  \"tvq\": 0.00,\n  \"total\": 0.00,\n  \"no_tps\": \"...\",\n  \"no_tvq\": \"...\",\n  \"categorie_comptable\": \"entretien, administration, electricite, etc.\",\n  \"mode_paiement\": \"cheque, virement, etc.\"\n}",

  auto: "Tu es un expert en documents corporatifs et comptables quebecois. Identifie d abord le type de document dans cette image (REQ, declaration de copropriete, facture, contrat, assurance, certificat, autre), puis extrais toutes les informations pertinentes en JSON STRICT:\n{\n  \"type_document\": \"REQ | DECLARATION_COPROPRIETE | FACTURE | CONTRAT | ASSURANCE | CERTIFICAT | AUTRE\",\n  \"confiance\": \"haute | moyenne | faible\",\n  \"donnees\": { toutes les donnees pertinentes selon le type }\n}"
};
