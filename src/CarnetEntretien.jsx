...
export default function CarnetEntretien(){
  ...
  function imprimer(){
    ...
    win.document.write("<html><head><title>Carnet entretien Loi 16</title><style>@font-face{font-family:ChiffresPredictek;src:local('Segoe UI'),local('Arial');unicode-range:U+0030-0039;}body{font-family:Arial,sans-serif;margin:20px;font-size:12px}h2{color:#13233A}table{width:100%;border-collapse:collapse;margin-top:12px}th,td{border:1px solid #ddd;padding:6px 8px}th{background:#f0f0f0;font-size:11px}.total{font-weight:bold;background:#e8f2ec;font-size:13px}.alerte{background:#FFF5F5}.info{background:#f8f9fa;padding:10px;border-radius:6px;margin:10px 0}</style></head><body>");
