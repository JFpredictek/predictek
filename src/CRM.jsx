...
"Art.17 CCQ-1040: Destination rÃ©sidentielle seulement. Usage professionnel interdit.\n" +
"Art.60 Acte: Assurance responsabilitÃ© civile minimum 2 000 000$ obligatoire pour chaque copropriÃ©taire.\n" +
"Art.72 Acte: SolidaritÃ© de l'acquÃ©reur - le nouvel acheteur est solidairement responsable des charges impayÃ©es.\n" +
"Art.74 Acte: Avis de mutation dans les 15 jours de la publication de l'acte.\n" +
"Art.77 Acte: Location permise. Avis au syndicat dans les 15 jours du bail. RÃ¨glement remis au locataire.\n" +
"Art.84 Acte: Travaux extÃ©rieurs requiÃ¨rent approbation Ã©crite du CA.\n" +
"Art.97-98 Acte: MÃ©diation et arbitrage obligatoires avant recours judiciaire.\n" +
"Art.107 Acte: PÃ©nalitÃ©s: 100$ premier avis, 150$ deuxiÃ¨me, +25$ par rÃ©cidive.\n" +
"Art.107.5 Acte: Location court terme (Airbnb): 300$/jour ou 125% du loyer mensuel si non autorisÃ©e.\n" +
"Art.114.11 Acte: RÃ©servoir eau chaude: remplacement obligatoire aux 10 ans.\n" +
"Art.114.16 Acte: Maximum 2 animaux domestiques. Pitbulls et races dangereuses interdits.\n" +
"Art.114.18 Acte: TempÃ©rature minimum 15Â°C en tout temps.\n" +
"Art.114.25-27 Acte: Piscines, spas, clÃ´tures et cordes Ã  linge interdits.\n" +
"Art.155 Acte: AssemblÃ©e annuelle dans les 90 jours de la clÃ´ture de l'exercice.\n" +
"Art.176 Acte: DÃ©faut de paiement de plus de 3 mois = perte du droit de vote.\n" +
"Art.177 Acte: Quorum = majoritÃ© des voix des copropriÃ©taires.\n" +
"Art.199 Acte: Paiement par prÃ©lÃ¨vement bancaire prÃ©autorisÃ© obligatoire.\n" +
"Art.201 Acte: Frais NSF: 52$ par paiement refusÃ©.\n" +
"Art.202 Acte: IntÃ©rÃªts sur arrÃ©rages: 18%/an (1.5%/mois).\n" +
"CCQ-1039: Le syndicat a la personnalitÃ© juridique. Il est propriÃ©taire des parties communes.\n" +
"CCQ-1064: Chaque copropriÃ©taire contribue aux charges communes selon sa fraction.\n" +
"CCQ-1071: Fonds de prÃ©voyance obligatoire. Minimum 5% des charges annuelles.\n" +
"CCQ-1072: Loi 16 - Ãtude du fonds de prÃ©voyance aux 5 ans obligatoire.\n" +
"CCQ-1074: Carnet d'entretien obligatoire. Tenu Ã  jour par le syndicat.";

const FOURNISSEURS_MINI=[
  {id:1,nom:"DÃ©neigement Express",tel:"418-555-1001",cats:["deneigement"],note:4.7},
...
const AGENTS=[
  {id:1,nom:"Jean-FranÃ§ois Laroche",initiales:"JL",role:"Super Admin",couleur:T.gold},
...
const CATEGORIES={
  copro_question:{label:"Question",icon:"?",couleur:T.blue,canAI:true,desc:"Question gÃ©nÃ©rale sur les rÃ¨glements, droits, obligations"},
  copro_plainte:{label:"Plainte",icon:"!",couleur:T.red,canAI:false,desc:"Plainte contre un voisin ou une situation"},
  copro_reparation:{label:"RÃ©paration",icon:"W",couleur:T.amber,canAI:false,desc:"Demande de rÃ©paration ou entretien"},
  ...
  admin_decision:{label:"DÃ©cision CA",icon:"C",couleur:T.accent,canAI:false,desc:"DÃ©cision ou rÃ©solution du CA"},
  admin_approbation:{label:"Approbation",icon:"V",couleur:T.accentMid,canAI:false,desc:"Approbation requise (facture, travaux...)"},
  admin_rapport:{label:"Rapport",icon:"R",couleur:T.navy,canAI:true,desc:"Demande de rapport financier ou opÃ©rationnel"},
  interne_bug:{label:"Bug technique",icon:"B",couleur:T.red,canAI:false,desc:"Bug ou problÃ¨me technique dans Predictek"},
...
const ASSIGN_MODES={
  ...
  auto_type:{label:"Auto par type",desc:"Assignation selon la catÃ©gorie de la demande"},
...
const STATUTS={
  ...
  ai_repond:{label:"IA rÃ©pond",c:T.purple,bg:T.purpleLight},
  en_cours:{label:"En cours",c:T.amber,bg:T.amberLight},
  attente_client:{label:"Att. client",c:T.gold,bg:T.goldLight},
  resolu:{label:"RÃ©solu",c:T.accent,bg:T.accentLight},
  ferme:{label:"FermÃ©",c:T.muted,bg:T.surfaceAlt},
};

const TICKETS_INIT=[
  {id:1001,synd:1,cat:"copro_question",sujet:"Puis-je louer mon unitÃ© sur Airbnb?",msg:"Bonjour, j'aimerais louer mon unitÃ© sur Airbnb les fins de semaine. Est-ce permis par le rÃ¨glement?",auteur:"Michel Beaudoin",unite:"515",canal:"portail",statut:"resolu",priorite:"normale",agent:1,dateCreation:"2026-04-15 09:23",dateMaj:"2026-04-15 09:31",aiReponsible:true,messages:[{from:"ai",date:"2026-04-15 09:31",txt:"Selon l'Art. 107.5 de votre dÃ©claration de copropriÃ©tÃ©, la location court terme de type Airbnb est permise mais soumise Ã  une pÃ©nalitÃ© de 300$/jour ou 125% du loyer mensuel si elle n'a pas Ã©tÃ© prÃ©alablement autorisÃ©e par le CA. Vous devez en aviser le syndicat par Ã©crit selon l'Art. 77. Je vous recommande de contacter le CA avant de procÃ©der."}]},
  {id:1002,synd:1,cat:"copro_plainte",sujet:"Bruit excessif â Voisin du dessus aprÃ¨s 23h",msg:"Mon voisin de l'unitÃ© 533 fait du bruit excessif aprÃ¨s 23h depuis 2 semaines. J'ai essayÃ© de lui parler mais Ã§a continue.",auteur:"Jean-FranÃ§ois Laroche",unite:"531",canal:"portail",statut:"en_cours",priorite:"haute",agent:2,dateCreation:"2026-04-19 22:41",dateMaj:"2026-04-20 10:15",aiReponsible:false,messages:[{from:"agent",nom:"Marie-Claude Bouchard",date:"2026-04-20 10:15",txt:"Bonjour M. Laroche, nous avons bien reÃ§u votre plainte. Un premier avis Ã©crit sera envoyÃ© Ã  l'unitÃ© 533 conformÃ©ment Ã  l'Art. 107 de votre dÃ©claration. Si la situation persiste, des pÃ©nalitÃ©s de 100$ (1er avis) puis 150$ (2e avis) s'appliqueront."}]},
  {id:1003,synd:1,cat:"copro_autorisation",sujet:"Demande installation thermopompe murale",msg:"Je souhaite installer une thermopompe murale sur le mur extÃ©rieur de mon unitÃ©. Quelles sont les dÃ©marches?",auteur:"Simon Pellerin",unite:"525",canal:"courriel",statut:"nouveau",priorite:"normale",agent:null,dateCreation:"2026-04-21 14:05",dateMaj:"2026-04-21 14:05",aiReponsible:true,messages:[]},
  {id:1004,synd:1,cat:"admin_approbation",sujet:"Approbation facture DÃ©neigement Express â 5 297,68$",msg:"Facture de dÃ©neigement de mars 2026 soumise pour approbation. Ref: FRNC-089",auteur:"Jean-FranÃ§ois Laroche",unite:null,canal:"manuel",statut:"en_cours",priorite:"haute",agent:1,dateCreation:"2026-04-20 08:00",dateMaj:"2026-04-20 08:00",aiReponsible:false,messages:[]},
  {id:1005,synd:2,cat:"copro_question",sujet:"Quelles sont les rÃ¨gles pour les animaux de compagnie?",msg:"Nous envisageons adopter un chien. Quelles sont les restrictions?",auteur:"Lucie Tremblay",unite:"204",canal:"portail",statut:"ai_repond",priorite:"normale",agent:null,dateCreation:"2026-04-22 11:30",dateMaj:"2026-04-22 11:30",aiReponsible:true,messages:[]},
  {id:1006,synd:1,cat:"copro_reparation",sujet:"Fuite d'eau dans le plafond du salon",msg:"Depuis hier soir, j'ai une infiltration d'eau dans mon plafond. La tache est d'environ 30cm de diamÃ¨tre et s'agrandit.",auteur:"Fabienne Maltais",unite:"527",canal:"portail",statut:"en_cours",priorite:"urgente",agent:2,dateCreation:"2026-04-22 18:45",dateMaj:"2026-04-22 18:45",aiReponsible:false,messages:[{from:"agent",nom:"Marie-Claude Bouchard",date:"2026-04-22 19:10",txt:"Bon de travail crÃ©Ã© et envoyÃ© Ã  Plomberie ProFlo. Intervention prÃ©vue demain matin."}],bon:{fourId:3,fourNom:"Plomberie ProFlo",bonId:101,titre:"Inspection et rÃ©paration fuite plafond â UnitÃ© 527",statut:"envoye",dateCreation:"2026-04-22"}},
  {id:1007,synd:3,cat:"interne_bug",sujet:"Erreur lors de la gÃ©nÃ©ration du rapport financier",msg:"Quand je clique sur 'GÃ©nÃ©rer rapport annuel', j'obtiens une erreur 500. Navigateur: Chrome 123.",auteur:"Robert HÃ©bert",unite:null,canal:"manuel",statut:"nouveau",priorite:"haute",agent:3,dateCreation:"2026-04-22 09:15",dateMaj:"2026-04-22 09:15",aiReponsible:false,messages:[]},
  {id:1008,synd:1,cat:"copro_document",sujet:"Demande de l'Ã©tat certifiÃ© des charges pour vente",msg:"Je vends mon unitÃ© et mon notaire demande un Ã©tat certifiÃ© des charges. Comment l'obtenir?",auteur:"Lucette Tremblay",unite:"539",canal:"courriel",statut:"nouveau",priorite:"haute",agent:null,dateCreation:"2026-04-22 16:20",dateMaj:"2026-04-22 16:20",aiReponsible:true,messages:[]},
];
...
function DetailTicket({ticket,onUpdate,onClose}){
  ...
  async function genAI(){
    setAiLoading(true);
    const prompt = "Tu es l'assistant juridique et gestionnaire de Predictek, expert en copropriÃ©tÃ© quÃ©bÃ©coise. " +
      "RÃ©ponds Ã  cette demande de "+ticket.auteur+(ticket.unite?" (UnitÃ© "+ticket.unite+", "+synd.nom+")":(" ("+synd.nom+")"))+".\n\n" +
      "DEMANDE: "+ticket.sujet+"\n"+ticket.msg+"\n\n" +
      "BASE LÃGALE APPLICABLE:\n"+BASE_LEGALE+"\n\n" +
      "Donne une rÃ©ponse professionnelle, prÃ©cise et bienveillante. Cite les articles applicables. " +
      "Si la demande nÃ©cessite une dÃ©cision humaine (plainte grave, travaux majeurs, litige), dis-le clairement. " +
      "RÃ©ponds en franÃ§ais quÃ©bÃ©cois professionnel.";
    try {
      const r=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"claude-sonnet-4-20250514",max_tokens:800,system:"Tu es l'assistant CRM de Predictek. RÃ©ponds toujours en franÃ§ais.",messages:[{role:"user",content:prompt}]})});
      const d=await r.json();
      const txt=d.content&&d.content[0]?d.content[0].text:"Erreur de gÃ©nÃ©ration.";
      setReply(txt);
    } catch(e){setReply("Erreur de connexion Ã  l'IA.");}
    setAiLoading(false);
  }
    ...
    <div style={{display:"flex",flexDirection:"column",height:"100%"}}>
      ...
      <div style={{padding:"14px 18px",borderBottom:"1px solid "+T.border,background:T.surfaceAlt}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:8}}>
          <div style={{flex:1}}>
            <div style={{display:"flex",gap:6,marginBottom:5,flexWrap:"wrap"}}>
              ...
              {ticket.aiReponsible&&<Tag l="IA activÃ©e" c={T.purple}/>}
            </div>
            <div style={{fontSize:14,fontWeight:700,color:T.text,marginBottom:3}}>{ticket.sujet}</div>
            <div style={{fontSize:11,color:T.muted}}>{ticket.auteur}{ticket.unite?" Â· UnitÃ© "+ticket.unite:""} Â· {synd?synd.court:""} Â· {ticket.dateCreation}</div>
          </div>
        ...
        <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
          {[{v:"en_cours",l:"En cours"},{v:"attente_client",l:"Att. client"},{v:"resolu",l:"RÃ©solu"},{v:"ferme",l:"FermÃ©"}].map(st=>(
      ...
      <div style={{display:"flex",gap:1,borderBottom:"1px solid "+T.border,padding:"0 18px",background:T.surface}}>
        {[{id:"conversation",l:"Conversation"},{id:"details",l:"DÃ©tails"},{id:"ia",l:"Assistant IA"},{id:"bon",l:"Bon de travail"}].map(t=>(
      ...
      <div style={{flex:1,overflowY:"auto",padding:"16px 18px"}}>
            ...
            <div style={{display:"flex",gap:10,marginBottom:16}}>
              ...
              <div style={{flex:1}}>
                <div style={{display:"flex",gap:8,alignItems:"center",marginBottom:5}}>
                  ...
                  {ticket.unite&&<Tag l={"UnitÃ© "+ticket.unite} c={T.muted}/>}
            ...
            {ticket.messages.map((m,i)=>{
              ...
              if(isNote) return(
                <div key={i} style={{margin:"10px 0",padding:"8px 12px",background:T.goldLight,borderRadius:8,border:"1px dashed "+T.gold+"50",fontSize:11,color:T.amber}}>
                  <b>Note interne ({m.nom})</b> Â· {m.date}<br/>{m.txt}
                </div>
              );
              return(
                <div key={i} style={{display:"flex",gap:10,marginBottom:14,flexDirection:isAI||isAgent?"row-reverse":"row"}}>
                  ...
                  <div style={{flex:1,maxWidth:"80%"}}>
                    <div style={{display:"flex",gap:7,alignItems:"center",marginBottom:4,flexDirection:isAI||isAgent?"row-reverse":"row"}}>
                      ...
                      {isAI&&<Tag l="GÃ©nÃ©rÃ© par IA" c={T.purple} sz={8}/>}
                    </div>
        ...
        {subTab==="details"&&(
          <div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:14}}>
              {[["Syndicat",synd?synd.nom:"â"],["Canal",ticket.canal],["PrioritÃ©",ticket.priorite],["Agent assignÃ©",agent?agent.nom:"Non assignÃ©"],["CrÃ©Ã© le",ticket.dateCreation],["Mis Ã  jour",ticket.dateMaj],["RÃ©ponse IA",ticket.aiReponsible?"ActivÃ©e":"DÃ©sactivÃ©e"],["Nb messages",ticket.messages.length]].map(([l,v],i)=>(
            ...
            <div style={{background:CATEGORIES[ticket.cat]?CATEGORIES[ticket.cat].couleur+"10":T.surfaceAlt,borderRadius:8,padding:"10px 14px",border:"1px solid "+(CATEGORIES[ticket.cat]?CATEGORIES[ticket.cat].couleur+"30":T.border)}}>
              <div style={{fontSize:10,color:T.muted,marginBottom:3}}>CatÃ©gorie</div>
        ...
        {subTab==="bon"&&(function(){
          ...
          var SETAPES={cree:{l:"CrÃ©Ã©",c:T.muted},envoye:{l:"EnvoyÃ©",c:T.blue},accepte:{l:"AcceptÃ©",c:T.accentMid},en_cours:{l:"En cours",c:T.amber},inspecte:{l:"InspectÃ©",c:T.purple},termine:{l:"TerminÃ©",c:T.accent},facture:{l:"FacturÃ©",c:T.gold},paye:{l:"PayÃ©",c:T.accentPop}};
              ...
              {bon?(
                <div>
                  <div style={{background:T.accentLight,border:"1px solid "+T.accent+"30",borderRadius:10,padding:"12px 16px",marginBottom:14}}>
                    <div style={{fontSize:11,color:T.muted,marginBottom:4,textTransform:"uppercase",fontWeight:600,letterSpacing:"0.08em"}}>Bon de travail liÃ©</div>
                  ...
                  <div style={{background:T.surfaceAlt,borderRadius:8,padding:"10px 14px",fontSize:11,color:T.muted}}>
                    CrÃ©Ã© le {bon.dateCreation} Â· Fournisseur notifiÃ© par courriel
                  </div>
                </div>
              ):(
                <div>
                  <div style={{background:T.amberLight,border:"1px solid "+T.amber+"30",borderRadius:10,padding:"12px 16px",marginBottom:14}}>
                    <div style={{fontSize:13,fontWeight:700,color:T.amber,marginBottom:4}}>Aucun bon de travail liÃ©</div>
                    <div style={{fontSize:11,color:T.muted}}>CrÃ©ez un bon de travail et assignez-le Ã  un fournisseur.</div>
                  </div>
                  {matchingFours.length>0&&(
                    <div style={{marginBottom:14}}>
                      <div style={{fontSize:11,fontWeight:600,color:T.muted,marginBottom:8,textTransform:"uppercase",letterSpacing:"0.08em"}}>Fournisseurs suggÃ©rÃ©s</div>
                      {matchingFours.map(function(f){return(
                        <div key={f.id} onClick={()=>setSelFour(f.id)}
                          ...
                          <div style={{flex:1}}>
                            ...
                            <div style={{fontSize:10,color:T.muted}}>{f.tel} Â· {f.cats.join(", ")}</div>
                          </div>
                          <div style={{fontSize:13,color:T.gold}}>{"â".repeat(Math.floor(f.note))} <span style={{fontSize:10,color:T.muted}}>{f.note}</span></div>
                          {selFour===f.id&&<Tag l="SÃ©lectionnÃ©" c={T.accent}/>}
                        </div>
                      );})}
                    </div>
                  )}
                  <Btn onClick={function(){
                    ...
                    var newBon={fourId:selFour,fourNom:f?f.nom:"?",bonId:bonId,titre:ticket.sujet+" â Unite "+ticket.unite,statut:"envoye",dateCreation:now().split(",")[0]};
          ...
          <div>
            <div style={{background:"linear-gradient(135deg,"+T.purpleLight+","+T.blueLight+")",borderRadius:10,padding:"12px 16px",marginBottom:14,border:"1px solid "+T.purple+"20"}}>
              ...
              <div style={{fontSize:11,color:T.muted,lineHeight:1.6}}>
                BasÃ© sur la dÃ©claration de copropriÃ©tÃ© Piedmont et le Code civil du QuÃ©bec.<br/>
                La rÃ©ponse gÃ©nÃ©rÃ©e peut Ãªtre modifiÃ©e avant envoi.
              </div>
            </div>
            {cat.canAI?(
              <div>
                <Btn onClick={genAI} bg={"linear-gradient(135deg,"+T.purple+","+T.blue+")"} s={{width:"100%",marginBottom:12,fontSize:12}}>
                  {aiLoading?"GÃ©nÃ©ration en cours...":"GÃ©nÃ©rer une rÃ©ponse avec l'IA"}
                </Btn>
                {aiLoading&&<div style={{textAlign:"center",padding:"20px",color:T.purple,fontSize:12}}>Consultation de la base lÃ©gale et de l'acte de copropriÃ©tÃ©...</div>}
              </div>
            ):(
              <div style={{background:T.amberLight,borderRadius:8,padding:"10px 14px",marginBottom:12,fontSize:11,color:T.amber}}>
                Cette catÃ©gorie ({cat.label}) nÃ©cessite une intervention humaine. L'IA peut vous aider Ã  rÃ©diger une rÃ©ponse mais ne rÃ©pondra pas automatiquement.
              </div>
            )}
          </div>
        )}
      ...
      <div style={{borderTop:"1px solid "+T.border,padding:"14px 18px",background:T.surface}}>
        <div style={{display:"flex",gap:6,marginBottom:8}}>
          {["RÃ©ponse client","Note interne"].map((t,i)=>(
        ...
        <textarea value={reply} onChange={e=>setReply(e.target.value)} rows={3}
          placeholder="RÃ©digez votre rÃ©ponse ou utilisez l'IA pour gÃ©nÃ©rer une rÃ©ponse..."
          style={{...inp,height:70,resize:"vertical",marginBottom:8,lineHeight:1.6}}/>
        <div style={{display:"flex",gap:7}}>
          <Btn onClick={()=>sendReply(false)} s={{flex:1,fontSize:11}}>Envoyer la rÃ©ponse</Btn>
          <Btn onClick={()=>sendReply(true)} bg={"linear-gradient(135deg,"+T.purple+","+T.blue+")"} s={{fontSize:11}}>Envoyer comme rÃ©ponse IA</Btn>
  ...
  return(
    <Modal open={open} onClose={onClose} title="Nouveau ticket" w={560}>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:10}}>
        ...
        <F l="Canal">
          <select value={form.canal} onChange={e=>sf("canal",e.target.value)} style={inp}>
            <option value="portail">Portail copropriÃ©taire</option>
      ...
      <F l="Sujet *" s={{marginBottom:10}}>
        <input value={form.sujet} onChange={e=>sf("sujet",e.target.value)} placeholder="RÃ©sumÃ© en une ligne" style={inp}/>
      </F>
      <F l="Message / Description *" s={{marginBottom:10}}>
        <textarea value={form.msg} onChange={e=>sf("msg",e.target.value)} rows={4}
          placeholder="Description complÃ¨te de la demande..." style={{...inp,height:90,resize:"vertical"}}/>
      </F>
      <F l="Assigner Ã  (optionnel)" s={{marginBottom:16}}>
      ...
      {CATEGORIES[form.cat]&&CATEGORIES[form.cat].canAI&&(
        <div style={{background:T.purpleLight,borderRadius:7,padding:"7px 11px",marginBottom:12,fontSize:11,color:T.purple}}>
          Cette catÃ©gorie est Ã©ligible Ã  la rÃ©ponse automatique par IA basÃ©e sur l'acte de copropriÃ©tÃ© et le CCQ.
        </div>
      )}
      <div style={{display:"flex",gap:8}}>
        <Btn onClick={save} s={{flex:1}}>CrÃ©er le ticket</Btn>
...
function VueConfig({config,setConfig}){
  ...
  return(
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
      ...
      <Card>
        <SH l="RÃ©ponse automatique par IA"/>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
          <div>
            <div style={{fontSize:12,fontWeight:600,color:T.text}}>Activer la rÃ©ponse IA automatique</div>
            <div style={{fontSize:10,color:T.muted}}>RÃ©pond sans intervention humaine si confiance Ã©levÃ©e</div>
          </div>
        ...
        <div>
          ...
          <div style={{display:"flex",justifyContent:"space-between",fontSize:9,color:T.muted}}>
            <span>50% â Permissif</span><span>95% â TrÃ¨s strict</span>
          </div>
        </div>
        <div style={{marginTop:12,background:T.purpleLight,borderRadius:7,padding:"8px 11px",fontSize:10,color:T.purple}}>
          CatÃ©gories IA activÃ©es: {Object.values(CATEGORIES).filter(c=>c.canAI).map(c=>c.label).join(", ")}
        </div>
      </Card>
      {config.mode==="auto_type"&&(
        <Card s={{gridColumn:"span 2"}}>
          <SH l="RÃ¨gles d'assignation par catÃ©gorie"/>
            ...
            {Object.entries(CATEGORIES).map(([k,v])=>(
              <div key={k} style={{display:"flex",alignItems:"center",gap:8,padding:"8px 11px",background:T.surfaceAlt,borderRadius:8}}>
                ...
                <select value={config.type_rules[k]||""} onChange={e=>setRule(k,e.target.value?parseInt(e.target.value):null)}
                  ...
                  {AGENTS.map(a=><option key={a.id} value={a.id}>{a.initiales} â {a.nom.split(" ")[0]}</option>)}
                </select>
              </div>
            ))}
          </div>
    ...
    <div style={{minHeight:"100vh",background:T.bg,fontFamily:"Georgia,serif",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{background:T.navy,padding:"0 20px",display:"flex",alignItems:"center",justifyContent:"space-between",height:50,flexShrink:0}}>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          <span style={{fontSize:11,color:T.accentPop,fontWeight:600}}>CRM â Centre de support</span>
        </div>
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          ...
          {stats.nonAssignes>0&&<div style={{background:T.amber,borderRadius:20,padding:"3px 10px",fontSize:10,color:"#fff",fontWeight:700}}>{stats.nonAssignes} non assignÃ©{stats.nonAssignes>1?"s":""}</div>}
          <Av ini="JL" c={T.gold} sz={28}/>
          <span style={{fontSize:10,color:"#8da0bb"}}>Jean-FranÃ§ois Laroche</span>
        </div>
      </div>
          ...
          <div style={{width:selTicket?420:900,flexShrink:0,display:"flex",flexDirection:"column",borderRight:selTicket?"1px solid "+T.border:"none"}}>
            ...
            <div style={{padding:"12px 16px",borderBottom:"1px solid "+T.border,background:T.surface}}>
              <div style={{display:"grid",gridTemplateColumns:"repeat(6,1fr)",gap:8,marginBottom:12}}>
                {[{l:"Total",v:stats.total,c:T.navy},{l:"Nouveaux",v:stats.nouveaux,c:T.blue},{l:"En cours",v:stats.enCours,c:T.amber},{l:"Urgents",v:stats.urgents,c:T.red},{l:"GÃ©rÃ©s IA",v:stats.aiHandled,c:T.purple},{l:"Non assignÃ©s",v:stats.nonAssignes,c:T.amber}].map((k,i)=>(
              ...
              <div style={{display:"flex",gap:7,flexWrap:"wrap",alignItems:"center"}}>
                ...
                {[
                  ...
                  {k:"cat",opts:[{v:"tous",l:"Toutes catÃ©gories"},...Object.entries(CATEGORIES).map(([k,v])=>({v:k,l:v.label}))]},
                  {k:"priorite",opts:[{v:"tous",l:"Toutes prioritÃ©s"},{v:"urgente",l:"Urgente"},{v:"haute",l:"Haute"},{v:"normale",l:"Normale"},{v:"basse",l:"Basse"}]},
                  {k:"agent",opts:[{v:"tous",l:"Tous agents"},{v:"none",l:"Non assignÃ©"},...AGENTS.map(a=>({v:a.id,l:a.initiales}))]},
                ].map(({k,opts})=>(
                  ...
                  <div key={t.id} onClick={()=>setSelTicket(sel?null:t)}
                    ...
                    <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:5}}>
                      <div style={{flex:1}}>
                        ...
                        <div style={{fontSize:10,color:T.muted}}>{t.auteur}{t.unite?" Â· UnitÃ© "+t.unite:""} Â· {sy?sy.court:""}</div>
                      </div>
      ...
      {tab==="stats"&&(
        <div style={{padding:"22px 26px",maxWidth:1200,margin:"0 auto",width:"100%"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:14,marginBottom:18}}>
            {[
              {l:"Tickets gÃ©rÃ©s par IA",v:tickets.filter(t=>t.aiReponsible).length+"/"+tickets.length,pct:Math.round(tickets.filter(t=>t.aiReponsible).length/tickets.length*100),c:T.purple},
              {l:"Tickets rÃ©solus",v:tickets.filter(t=>["resolu","ferme"].includes(t.statut)).length+"/"+tickets.length,pct:Math.round(tickets.filter(t=>["resolu","ferme"].includes(t.statut)).length/tickets.length*100),c:T.accent},
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14}}>
            ...
            <Card>
                ...
                return(
                  <div key={s.id} style={{marginBottom:12}}>
                    <div style={{display:"flex",justifyContent:"space-between",marginBottom:4}}>
                      ...
                      <span style={{fontSize:11,color:T.muted}}>{resolus}/{n} rÃ©solus</span>
                    </div>
              ...
              <Card s={{marginTop:14,background:T.purpleLight,border:"1px solid "+T.purple+"20"}}>
                ...
                <div style={{fontSize:11,color:T.muted}}>des tickets traitÃ©s automatiquement par l'IA</div>
                <div style={{fontSize:10,color:T.purple,marginTop:6}}>BasÃ© sur: Acte Piedmont + CCQ + Code civil QC</div>
              </Card>
            </Card>
          </div>
        </div>
      ...
      {tab==="config_crm"&&(
        <div style={{padding:"22px 26px",maxWidth:1200,margin:"0 auto",width:"100%"}}>
          ...
          <p style={{color:T.muted,fontSize:12,marginBottom:18}}>Mode d'assignation, rÃ©ponse IA automatique, rÃ¨gles par catÃ©gorie</p>
