...
"Art.17 CCQ-1040: Destination rÃÂ©sidentielle seulement. Usage professionnel interdit.\n" +
"Art.60 Acte: Assurance responsabilitÃÂ© civile minimum 2 000 000$ obligatoire pour chaque copropriÃÂ©taire.\n" +
"Art.72 Acte: SolidaritÃÂ© de l'acquÃÂ©reur - le nouvel acheteur est solidairement responsable des charges impayÃÂ©es.\n" +
"Art.74 Acte: Avis de mutation dans les 15 jours de la publication de l'acte.\n" +
"Art.77 Acte: Location permise. Avis au syndicat dans les 15 jours du bail. RÃÂ¨glement remis au locataire.\n" +
"Art.84 Acte: Travaux extÃÂ©rieurs requiÃÂ¨rent approbation ÃÂ©crite du CA.\n" +
"Art.97-98 Acte: MÃÂ©diation et arbitrage obligatoires avant recours judiciaire.\n" +
"Art.107 Acte: PÃÂ©nalitÃÂ©s: 100$ premier avis, 150$ deuxiÃÂ¨me, +25$ par rÃÂ©cidive.\n" +
"Art.107.5 Acte: Location court terme (Airbnb): 300$/jour ou 125% du loyer mensuel si non autorisÃÂ©e.\n" +
"Art.114.11 Acte: RÃÂ©servoir eau chaude: remplacement obligatoire aux 10 ans.\n" +
"Art.114.16 Acte: Maximum 2 animaux domestiques. Pitbulls et races dangereuses interdits.\n" +
"Art.114.18 Acte: TempÃÂ©rature minimum 15ÃÂ°C en tout temps.\n" +
"Art.114.25-27 Acte: Piscines, spas, clÃÂ´tures et cordes ÃÂ  linge interdits.\n" +
"Art.155 Acte: AssemblÃÂ©e annuelle dans les 90 jours de la clÃÂ´ture de l'exercice.\n" +
"Art.176 Acte: DÃÂ©faut de paiement de plus de 3 mois = perte du droit de vote.\n" +
"Art.177 Acte: Quorum = majoritÃÂ© des voix des copropriÃÂ©taires.\n" +
"Art.199 Acte: Paiement par prÃÂ©lÃÂ¨vement bancaire prÃÂ©autorisÃÂ© obligatoire.\n" +
"Art.201 Acte: Frais NSF: 52$ par paiement refusÃÂ©.\n" +
"Art.202 Acte: IntÃÂ©rÃÂªts sur arrÃÂ©rages: 18%/an (1.5%/mois).\n" +
"CCQ-1039: Le syndicat a la personnalitÃÂ© juridique. Il est propriÃÂ©taire des parties communes.\n" +
"CCQ-1064: Chaque copropriÃÂ©taire contribue aux charges communes selon sa fraction.\n" +
"CCQ-1071: Fonds de prÃÂ©voyance obligatoire. Minimum 5% des charges annuelles.\n" +
"CCQ-1072: Loi 16 - ÃÂtude du fonds de prÃÂ©voyance aux 5 ans obligatoire.\n" +
"CCQ-1074: Carnet d'entretien obligatoire. Tenu ÃÂ  jour par le syndicat.";

const FOURNISSEURS_MINI=[
  {id:1,nom:"DÃÂ©neigement Express",tel:"418-555-1001",cats:["deneigement"],note:0},
...
const AGENTS=[
  {id:1,nom:"Jean-FranÃÂ§ois Laroche",initiales:"JL",role:"Super Admin",couleur:T.gold},
...
const CATEGORIES={
  copro_question:{label:"Question",icon:"?",couleur:T.blue,canAI:true,desc:"Question gÃÂ©nÃÂ©rale sur les rÃÂ¨glements, droits, obligations"},
  copro_plainte:{label:"Plainte",icon:"!",couleur:T.red,canAI:false,desc:"Plainte contre un voisin ou une situation"},
  copro_reparation:{label:"RÃÂ©paration",icon:"W",couleur:T.amber,canAI:false,desc:"Demande de rÃÂ©paration ou entretien"},
  ...
  admin_decision:{label:"DÃÂ©cision CA",icon:"C",couleur:T.accent,canAI:false,desc:"DÃÂ©cision ou rÃÂ©solution du CA"},
  admin_approbation:{label:"Approbation",icon:"V",couleur:T.accentMid,canAI:false,desc:"Approbation requise (facture, travaux...)"},
  admin_rapport:{label:"Rapport",icon:"R",couleur:T.navy,canAI:true,desc:"Demande de rapport financier ou opÃÂ©rationnel"},
  interne_bug:{label:"Bug technique",icon:"B",couleur:T.red,canAI:false,desc:"Bug ou problÃÂ¨me technique dans Predictek"},
...
const ASSIGN_MODES={
  ...
  auto_type:{label:"Auto par type",desc:"Assignation selon la catÃÂ©gorie de la demande"},
...
const STATUTS={
  ...
  ai_repond:{label:"IA rÃÂ©pond",c:T.purple,bg:T.purpleLight},
  en_cours:{label:"En cours",c:T.amber,bg:T.amberLight},
  attente_client:{label:"Att. client",c:T.gold,bg:T.goldLight},
  resolu:{label:"RÃÂ©solu",c:T.accent,bg:T.accentLight},
  ferme:{label:"FermÃÂ©",c:T.muted,bg:T.surfaceAlt},
};

const TICKETS_INIT=[
  {id:1001,synd:1,cat:"copro_question",sujet:"Puis-je louer mon unitÃÂ© sur Airbnb?",msg:"Bonjour, j'aimerais louer mon unitÃÂ© sur Airbnb les fins de semaine. Est-ce permis par le rÃÂ¨glement?",auteur:"Michel Beaudoin",unite:"515",canal:"portail",statut:"resolu",priorite:"normale",agent:1,dateCreation:"2026-04-15 09:23",dateMaj:"2026-04-15 09:31",aiReponsible:true,messages:[{from:"ai",date:"2026-04-15 09:31",txt:"Selon l'Art. 107.5 de votre dÃÂ©claration de copropriÃÂ©tÃÂ©, la location court terme de type Airbnb est permise mais soumise ÃÂ  une pÃÂ©nalitÃÂ© de 300$/jour ou 125% du loyer mensuel si elle n'a pas ÃÂ©tÃÂ© prÃÂ©alablement autorisÃÂ©e par le CA. Vous devez en aviser le syndicat par ÃÂ©crit selon l'Art. 77. Je vous recommande de contacter le CA avant de procÃÂ©der."}]},
  {id:1002,synd:1,cat:"copro_plainte",sujet:"Bruit excessif Ã¢ÂÂ Voisin du dessus aprÃÂ¨s 23h",msg:"Mon voisin de l'unitÃÂ© 533 fait du bruit excessif aprÃÂ¨s 23h depuis 2 semaines. J'ai essayÃÂ© de lui parler mais ÃÂ§a continue.",auteur:"Jean-FranÃÂ§ois Laroche",unite:"531",canal:"portail",statut:"en_cours",priorite:"haute",agent:2,dateCreation:"2026-04-19 22:41",dateMaj:"2026-04-20 10:15",aiReponsible:false,messages:[{from:"agent",nom:"Marie-Claude Bouchard",date:"2026-04-20 10:15",txt:"Bonjour M. Laroche, nous avons bien reÃÂ§u votre plainte. Un premier avis ÃÂ©crit sera envoyÃÂ© ÃÂ  l'unitÃÂ© 533 conformÃÂ©ment ÃÂ  l'Art. 107 de votre dÃÂ©claration. Si la situation persiste, des pÃÂ©nalitÃÂ©s de 100$ (1er avis) puis 150$ (2e avis) s'appliqueront."}]},
  {id:1003,synd:1,cat:"copro_autorisation",sujet:"Demande installation thermopompe murale",msg:"Je souhaite installer une thermopompe murale sur le mur extÃÂ©rieur de mon unitÃÂ©. Quelles sont les dÃÂ©marches?",auteur:"Simon Pellerin",unite:"525",canal:"courriel",statut:"nouveau",priorite:"normale",agent:null,dateCreation:"2026-04-21 14:05",dateMaj:"2026-04-21 14:05",aiReponsible:true,messages:[]},
  {id:1004,synd:1,cat:"admin_approbation",sujet:"Approbation facture DÃÂ©neigement Express Ã¢ÂÂ 5 297,68$",msg:"Facture de dÃÂ©neigement de mars 2026 soumise pour approbation. Ref: FRNC-089",auteur:"Jean-FranÃÂ§ois Laroche",unite:null,canal:"manuel",statut:"en_cours",priorite:"haute",agent:1,dateCreation:"2026-04-20 08:00",dateMaj:"2026-04-20 08:00",aiReponsible:false,messages:[]},
  {id:1005,synd:2,cat:"copro_question",sujet:"Quelles sont les rÃÂ¨gles pour les animaux de compagnie?",msg:"Nous envisageons adopter un chien. Quelles sont les restrictions?",auteur:"Lucie Tremblay",unite:"204",canal:"portail",statut:"ai_repond",priorite:"normale",agent:null,dateCreation:"2026-04-22 11:30",dateMaj:"2026-04-22 11:30",aiReponsible:true,messages:[]},
  {id:1006,synd:1,cat:"copro_reparation",sujet:"Fuite d'eau dans le plafond du salon",msg:"Depuis hier soir, j'ai une infiltration d'eau dans mon plafond. La tache est d'environ 30cm de diamÃÂ¨tre et s'agrandit.",auteur:"Fabienne Maltais",unite:"527",canal:"portail",statut:"en_cours",priorite:"urgente",agent:2,dateCreation:"2026-04-22 18:45",dateMaj:"2026-04-22 18:45",aiReponsible:false,messages:[{from:"agent",nom:"Marie-Claude Bouchard",date:"2026-04-22 19:10",txt:"Bon de travail crÃÂ©ÃÂ© et envoyÃÂ© ÃÂ  Plomberie ProFlo. Intervention prÃÂ©vue demain matin."}],bon:{fourId:3,fourNom:"Plomberie ProFlo",bonId:101,titre:"Inspection et rÃÂ©paration fuite plafond Ã¢ÂÂ UnitÃÂ© 527",statut:"envoye",dateCreation:"2026-04-22"}},
  {id:1007,synd:3,cat:"interne_bug",sujet:"Erreur lors de la gÃÂ©nÃÂ©ration du rapport financier",msg:"Quand je clique sur 'GÃÂ©nÃÂ©rer rapport annuel', j'obtiens une erreur 500. Navigateur: Chrome 123.",auteur:"Robert HÃÂ©bert",unite:null,canal:"manuel",statut:"nouveau",priorite:"haute",agent:3,dateCreation:"2026-04-22 09:15",dateMaj:"2026-04-22 09:15",aiReponsible:false,messages:[]},
  {id:1008,synd:1,cat:"copro_document",sujet:"Demande de l'ÃÂ©tat certifiÃÂ© des charges pour vente",msg:"Je vends mon unitÃÂ© et mon notaire demande un ÃÂ©tat certifiÃÂ© des charges. Comment l'obtenir?",auteur:"Lucette Tremblay",unite:"539",canal:"courriel",statut:"nouveau",priorite:"haute",agent:null,dateCreation:"2026-04-22 16:20",dateMaj:"2026-04-22 16:20",aiReponsible:true,messages:[]},
];
...
function DetailTicket({ticket,onUpdate,onClose}){
  ...
  async function genAI(){
    setAiLoading(true);
    const prompt = "Tu es l'assistant juridique et gestionnaire de Predictek, expert en copropriÃÂ©tÃÂ© quÃÂ©bÃÂ©coise. " +
      "RÃÂ©ponds ÃÂ  cette demande de "+ticket.auteur+(ticket.unite?" (UnitÃÂ© "+ticket.unite+", "+synd.nom+")":(" ("+synd.nom+")"))+".\n\n" +
      "DEMANDE: "+ticket.sujet+"\n"+ticket.msg+"\n\n" +
      "BASE LÃÂGALE APPLICABLE:\n"+BASE_LEGALE+"\n\n" +
      "Donne une rÃÂ©ponse professionnelle, prÃÂ©cise et bienveillante. Cite les articles applicables. " +
      "Si la demande nÃÂ©cessite une dÃÂ©cision humaine (plainte grave, travaux majeurs, litige), dis-le clairement. " +
      "RÃÂ©ponds en franÃÂ§ais quÃÂ©bÃÂ©cois professionnel.";
    try {
      const r=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"claude-sonnet-4-20250514",max_tokens:800,system:"Tu es l'assistant CRM de Predictek. RÃÂ©ponds toujours en franÃÂ§ais.",messages:[{role:"user",content:prompt}]})});
      const d=await r.json();
      const txt=d.content&&d.content[0]?d.content[0].text:"Erreur de gÃÂ©nÃÂ©ration.";
      setReply(txt);
    } catch(e){setReply("Erreur de connexion ÃÂ  l'IA.");}
    setAiLoading(false);
  }
    ...
    <div style={{display:"flex",flexDirection:"column",height:"100%"}}>
      ...
      <div style={{padding:"14px 18px",borderBottom:"1px solid "+T.border,background:T.surfaceAlt}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:8}}>
          <div style={{flex:1}}>
            <div style={{display:"flex",gap:6,marginBottom:5,flexWrap:"wrap"}}>
              ...
              {ticket.aiReponsible&&<Tag l="IA activÃÂ©e" c={T.purple}/>}
            </div>
            <div style={{fontSize:14,fontWeight:700,color:T.text,marginBottom:3}}>{ticket.sujet}</div>
            <div style={{fontSize:11,color:T.muted}}>{ticket.auteur}{ticket.unite?" ÃÂ· UnitÃÂ© "+ticket.unite:""} ÃÂ· {synd?synd.court:""} ÃÂ· {ticket.dateCreation}</div>
          </div>
        ...
        <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
          {[{v:"en_cours",l:"En cours"},{v:"attente_client",l:"Att. client"},{v:"resolu",l:"RÃÂ©solu"},{v:"ferme",l:"FermÃÂ©"}].map(st=>(
          ...
          <div style={{marginLeft:"auto",display:"flex",gap:5,alignItems:"center"}}>
            ...
            <select value={ticket.agent||""} onChange={e=>onUpdate(ticket.id,{agent:parseInt(e.target.value)||null})}
              ...
              <option value="">Non assignÃÂ©</option>
      ...
      <div style={{display:"flex",gap:1,borderBottom:"1px solid "+T.border,padding:"0 18px",background:T.surface}}>
        {[{id:"conversation",l:"Conversation"},{id:"details",l:"DÃÂ©tails"},{id:"ia",l:"Assistant IA"},{id:"bon",l:"Bon de travail"}].map(t=>(
      ...
      <div style={{flex:1,overflowY:"auto",padding:"16px 18px"}}>
            ...
            <div style={{display:"flex",gap:10,marginBottom:16}}>
              ...
              <div style={{flex:1}}>
                <div style={{display:"flex",gap:8,alignItems:"center",marginBottom:5}}>
                  ...
                  {ticket.unite&&<Tag l={"UnitÃÂ© "+ticket.unite} c={T.muted}/>}
            ...
            {ticket.messages.map((m,i)=>{
              ...
              if(isNote) return(
                <div key={i} style={{margin:"10px 0",padding:"8px 12px",background:T.goldLight,borderRadius:8,border:"1px dashed "+T.gold+"50",fontSize:11,color:T.amber}}>
                  <b>Note interne ({m.nom})</b> ÃÂ· {m.date}<br/>{m.txt}
                </div>
              );
              return(
                <div key={i} style={{display:"flex",gap:10,marginBottom:14,flexDirection:isAI||isAgent?"row-reverse":"row"}}>
                  ...
                  <div style={{flex:1,maxWidth:"80%"}}>
                    <div style={{display:"flex",gap:7,alignItems:"center",marginBottom:4,flexDirection:isAI||isAgent?"row-reverse":"row"}}>
                      ...
                      {isAI&&<Tag l="GÃÂ©nÃÂ©rÃÂ© par IA" c={T.purple} sz={8}/>}
                    </div>
        ...
        {subTab==="details"&&(
          <div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:14}}>
              {[["Syndicat",synd?synd.nom:"Ã¢ÂÂ"],["Canal",ticket.canal],["PrioritÃÂ©",ticket.priorite],["Agent assignÃÂ©",agent?agent.nom:"Non assignÃÂ©"],["CrÃÂ©ÃÂ© le",ticket.dateCreation],["Mis ÃÂ  jour",ticket.dateMaj],["RÃÂ©ponse IA",ticket.aiReponsible?"ActivÃÂ©e":"DÃÂ©sactivÃÂ©e"],["Nb messages",ticket.messages.length]].map(([l,v],i)=>(
            ...
            <div style={{background:CATEGORIES[ticket.cat]?CATEGORIES[ticket.cat].couleur+"10":T.surfaceAlt,borderRadius:8,padding:"10px 14px",border:"1px solid "+(CATEGORIES[ticket.cat]?CATEGORIES[ticket.cat].couleur+"30":T.border)}}>
              <div style={{fontSize:10,color:T.muted,marginBottom:3}}>CatÃÂ©gorie</div>
        ...
        {subTab==="bon"&&(function(){
          ...
          var SETAPES={cree:{l:"CrÃÂ©ÃÂ©",c:T.muted},envoye:{l:"EnvoyÃÂ©",c:T.blue},accepte:{l:"AcceptÃÂ©",c:T.accentMid},en_cours:{l:"En cours",c:T.amber},inspecte:{l:"InspectÃÂ©",c:T.purple},termine:{l:"TerminÃÂ©",c:T.accent},facture:{l:"FacturÃÂ©",c:T.gold},paye:{l:"PayÃÂ©",c:T.accentPop}};
              ...
              {bon?(
                <div>
                  <div style={{background:T.accentLight,border:"1px solid "+T.accent+"30",borderRadius:10,padding:"12px 16px",marginBottom:14}}>
                    <div style={{fontSize:11,color:T.muted,marginBottom:4,textTransform:"uppercase",fontWeight:600,letterSpacing:"0.08em"}}>Bon de travail liÃÂ©</div>
                  ...
                  <div style={{background:T.surfaceAlt,borderRadius:8,padding:"10px 14px",fontSize:11,color:T.muted}}>
                    CrÃÂ©ÃÂ© le {bon.dateCreation} ÃÂ· Fournisseur notifiÃÂ© par courriel
                  </div>
                </div>
              ):(
                <div>
                  <div style={{background:T.amberLight,border:"1px solid "+T.amber+"30",borderRadius:10,padding:"12px 16px",marginBottom:14}}>
                    <div style={{fontSize:13,fontWeight:700,color:T.amber,marginBottom:4}}>Aucun bon de travail liÃÂ©</div>
                    <div style={{fontSize:11,color:T.muted}}>CrÃÂ©ez un bon de travail et assignez-le ÃÂ  un fournisseur.</div>
                  </div>
                  {matchingFours.length>0&&(
                    <div style={{marginBottom:14}}>
                      <div style={{fontSize:11,fontWeight:600,color:T.muted,marginBottom:8,textTransform:"uppercase",letterSpacing:"0.08em"}}>Fournisseurs suggÃÂ©rÃÂ©s</div>
                      {matchingFours.map(function(f){return(
                        <div key={f.id} onClick={()=>setSelFour(f.id)}
                          ...
                          <div style={{flex:1}}>
                            ...
                            <div style={{fontSize:10,color:T.muted}}>{f.tel} ÃÂ· {f.cats.join(", ")}</div>
                          </div>
                          <div style={{fontSize:13,color:T.gold}}>{"Ã¢ÂÂ".repeat(Math.floor(f.note))} <span style={{fontSize:10,color:T.muted}}>{f.note}</span></div>
                          {selFour===f.id&&<Tag l="SÃÂ©lectionnÃÂ©" c={T.accent}/>}
                        </div>
                      );})}
                    </div>
                  )}
                  <Btn onClick={function(){
                    ...
                    var newBon={fourId:selFour,fourNom:f?f.nom:"?",bonId:bonId,titre:ticket.sujet+" Ã¢ÂÂ Unite "+ticket.unite,statut:"envoye",dateCreation:now().split(",")[0]};
          ...
          <div>
            <div style={{background:"linear-gradient(135deg,"+T.purpleLight+","+T.blueLight+")",borderRadius:10,padding:"12px 16px",marginBottom:14,border:"1px solid "+T.purple+"20"}}>
              ...
              <div style={{fontSize:11,color:T.muted,lineHeight:1.6}}>
                BasÃÂ© sur la dÃÂ©claration de copropriÃÂ©tÃÂ© Piedmont et le Code civil du QuÃÂ©bec.<br/>
                La rÃÂ©ponse gÃÂ©nÃÂ©rÃÂ©e peut ÃÂªtre modifiÃÂ©e avant envoi.
              </div>
            </div>
            {cat.canAI?(
              <div>
                <Btn onClick={genAI} bg={"linear-gradient(135deg,"+T.purple+","+T.blue+")"} s={{width:"100%",marginBottom:12,fontSize:12}}>
                  {aiLoading?"GÃÂ©nÃÂ©ration en cours...":"GÃÂ©nÃÂ©rer une rÃÂ©ponse avec l'IA"}
                </Btn>
                {aiLoading&&<div style={{textAlign:"center",padding:"20px",color:T.purple,fontSize:12}}>Consultation de la base lÃÂ©gale et de l'acte de copropriÃÂ©tÃÂ©...</div>}
              </div>
            ):(
              <div style={{background:T.amberLight,borderRadius:8,padding:"10px 14px",marginBottom:12,fontSize:11,color:T.amber}}>
                Cette catÃÂ©gorie ({cat.label}) nÃÂ©cessite une intervention humaine. L'IA peut vous aider ÃÂ  rÃÂ©diger une rÃÂ©ponse mais ne rÃÂ©pondra pas automatiquement.
              </div>
            )}
          </div>
        )}
      ...
      <div style={{borderTop:"1px solid "+T.border,padding:"14px 18px",background:T.surface}}>
        <div style={{display:"flex",gap:6,marginBottom:8}}>
          {["RÃÂ©ponse client","Note interne"].map((t,i)=>(
        ...
        <textarea value={reply} onChange={e=>setReply(e.target.value)} rows={3}
          placeholder="RÃÂ©digez votre rÃÂ©ponse ou utilisez l'IA pour gÃÂ©nÃÂ©rer une rÃÂ©ponse..."
          style={{...inp,height:70,resize:"vertical",marginBottom:8,lineHeight:1.6}}/>
        <div style={{display:"flex",gap:7}}>
          <Btn onClick={()=>sendReply(false)} s={{flex:1,fontSize:11}}>Envoyer la rÃÂ©ponse</Btn>
          <Btn onClick={()=>sendReply(true)} bg={"linear-gradient(135deg,"+T.purple+","+T.blue+")"} s={{fontSize:11}}>Envoyer comme rÃÂ©ponse IA</Btn>
  ...
  return(
    <Modal open={open} onClose={onClose} title="Nouveau ticket" w={560}>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:10}}>
        ...
        <F l="UnitÃÂ© (si copropriÃÂ©taire)">
        ...
        <F l="Canal">
          <select value={form.canal} onChange={e=>sf("canal",e.target.value)} style={inp}>
            <option value="portail">Portail copropriÃÂ©taire</option>
            <option value="courriel">Courriel</option>
            <option value="manuel">Saisie manuelle</option>
            <option value="telephone">TÃÂ©lÃÂ©phone</option>
          </select>
        </F>
        <F l="PrioritÃÂ©">
      ...
      <F l="Sujet *" s={{marginBottom:10}}>
        <input value={form.sujet} onChange={e=>sf("sujet",e.target.value)} placeholder="RÃÂ©sumÃÂ© en une ligne" style={inp}/>
      </F>
      <F l="Message / Description *" s={{marginBottom:10}}>
        <textarea value={form.msg} onChange={e=>sf("msg",e.target.value)} rows={4}
          placeholder="Description complÃÂ¨te de la demande..." style={{...inp,height:90,resize:"vertical"}}/>
      </F>
      <F l="Assigner ÃÂ  (optionnel)" s={{marginBottom:16}}>
      ...
      {CATEGORIES[form.cat]&&CATEGORIES[form.cat].canAI&&(
        <div style={{background:T.purpleLight,borderRadius:7,padding:"7px 11px",marginBottom:12,fontSize:11,color:T.purple}}>
          Cette catÃÂ©gorie est ÃÂ©ligible ÃÂ  la rÃÂ©ponse automatique par IA basÃÂ©e sur l'acte de copropriÃÂ©tÃÂ© et le CCQ.
        </div>
      )}
      <div style={{display:"flex",gap:8}}>
        <Btn onClick={save} s={{flex:1}}>CrÃÂ©er le ticket</Btn>
...
function VueConfig({config,setConfig}){
  ...
  return(
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
      ...
      <Card>
        <SH l="RÃÂ©ponse automatique par IA"/>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
          <div>
            <div style={{fontSize:12,fontWeight:600,color:T.text}}>Activer la rÃÂ©ponse IA automatique</div>
            <div style={{fontSize:10,color:T.muted}}>RÃÂ©pond sans intervention humaine si confiance ÃÂ©levÃÂ©e</div>
          </div>
        ...
        <div>
          ...
          <div style={{display:"flex",justifyContent:"space-between",fontSize:9,color:T.muted}}>
            <span>50% Ã¢ÂÂ Permissif</span><span>95% Ã¢ÂÂ TrÃÂ¨s strict</span>
          </div>
        </div>
        <div style={{marginTop:12,background:T.purpleLight,borderRadius:7,padding:"8px 11px",fontSize:10,color:T.purple}}>
          CatÃÂ©gories IA activÃÂ©es: {Object.values(CATEGORIES).filter(c=>c.canAI).map(c=>c.label).join(", ")}
        </div>
      </Card>
      {config.mode==="auto_type"&&(
        <Card s={{gridColumn:"span 2"}}>
          <SH l="RÃÂ¨gles d'assignation par catÃÂ©gorie"/>
            ...
            {Object.entries(CATEGORIES).map(([k,v])=>(
              <div key={k} style={{display:"flex",alignItems:"center",gap:8,padding:"8px 11px",background:T.surfaceAlt,borderRadius:8}}>
                ...
                <select value={config.type_rules[k]||""} onChange={e=>setRule(k,e.target.value?parseInt(e.target.value):null)}
                  ...
                  {AGENTS.map(a=><option key={a.id} value={a.id}>{a.initiales} Ã¢ÂÂ {a.nom.split(" ")[0]}</option>)}
                </select>
              </div>
            ))}
          </div>
    ...
    <div style={{minHeight:"100vh",background:T.bg,fontFamily:"Georgia,serif",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{background:T.navy,padding:"0 20px",display:"flex",alignItems:"center",justifyContent:"space-between",height:50,flexShrink:0}}>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          <span style={{fontSize:11,color:T.accentPop,fontWeight:600}}>CRM Ã¢ÂÂ Centre de support</span>
        </div>
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          ...
          {stats.nonAssignes>0&&<div style={{background:T.amber,borderRadius:20,padding:"3px 10px",fontSize:10,color:"#fff",fontWeight:700}}>{stats.nonAssignes} non assignÃÂ©{stats.nonAssignes>1?"s":""}</div>}
          <Av ini="JL" c={T.gold} sz={28}/>
          <span style={{fontSize:10,color:"#8da0bb"}}>Jean-FranÃÂ§ois Laroche</span>
        </div>
      </div>
          ...
          <div style={{width:selTicket?420:900,flexShrink:0,display:"flex",flexDirection:"column",borderRight:selTicket?"1px solid "+T.border:"none"}}>
            ...
            <div style={{padding:"12px 16px",borderBottom:"1px solid "+T.border,background:T.surface}}>
              <div style={{display:"grid",gridTemplateColumns:"repeat(6,1fr)",gap:8,marginBottom:12}}>
                {[{l:"Total",v:stats.total,c:T.navy},{l:"Nouveaux",v:stats.nouveaux,c:T.blue},{l:"En cours",v:stats.enCours,c:T.amber},{l:"Urgents",v:stats.urgents,c:T.red},{l:"GÃÂ©rÃÂ©s IA",v:stats.aiHandled,c:T.purple},{l:"Non assignÃÂ©s",v:stats.nonAssignes,c:T.amber}].map((k,i)=>(
              ...
              <div style={{display:"flex",gap:7,flexWrap:"wrap",alignItems:"center"}}>
                ...
                {[
                  ...
                  {k:"cat",opts:[{v:"tous",l:"Toutes catÃÂ©gories"},...Object.entries(CATEGORIES).map(([k,v])=>({v:k,l:v.label}))]},
                  {k:"priorite",opts:[{v:"tous",l:"Toutes prioritÃÂ©s"},{v:"urgente",l:"Urgente"},{v:"haute",l:"Haute"},{v:"normale",l:"Normale"},{v:"basse",l:"Basse"}]},
                  {k:"agent",opts:[{v:"tous",l:"Tous agents"},{v:"none",l:"Non assignÃÂ©"},...AGENTS.map(a=>({v:a.id,l:a.initiales}))]},
                ].map(({k,opts})=>(
                  ...
                  <div key={t.id} onClick={()=>setSelTicket(sel?null:t)}
                    ...
                    <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:5}}>
                      <div style={{flex:1}}>
                        ...
                        <div style={{fontSize:10,color:T.muted}}>{t.auteur}{t.unite?" ÃÂ· UnitÃÂ© "+t.unite:""} ÃÂ· {sy?sy.court:""}</div>
                      </div>
      ...
      {tab==="stats"&&(
        <div style={{padding:"22px 26px",maxWidth:1200,margin:"0 auto",width:"100%"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:14,marginBottom:18}}>
            {[
              {l:"Tickets gÃÂ©rÃÂ©s par IA",v:tickets.filter(t=>t.aiReponsible).length+"/"+tickets.length,pct:Math.round(tickets.filter(t=>t.aiReponsible).length/tickets.length*100),c:T.purple},
              {l:"Tickets rÃÂ©solus",v:tickets.filter(t=>["resolu","ferme"].includes(t.statut)).length+"/"+tickets.length,pct:Math.round(tickets.filter(t=>["resolu","ferme"].includes(t.statut)).length/tickets.length*100),c:T.accent},
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14}}>
            ...
            <Card>
                ...
                return(
                  <div key={s.id} style={{marginBottom:12}}>
                    <div style={{display:"flex",justifyContent:"space-between",marginBottom:4}}>
                      ...
                      <span style={{fontSize:11,color:T.muted}}>{resolus}/{n} rÃÂ©solus</span>
                    </div>
              ...
              <Card s={{marginTop:14,background:T.purpleLight,border:"1px solid "+T.purple+"20"}}>
                ...
                <div style={{fontSize:11,color:T.muted}}>des tickets traitÃÂ©s automatiquement par l'IA</div>
                <div style={{fontSize:10,color:T.purple,marginTop:6}}>BasÃÂ© sur: Acte Piedmont + CCQ + Code civil QC</div>
              </Card>
            </Card>
          </div>
        </div>
      ...
      {tab==="config_crm"&&(
        <div style={{padding:"22px 26px",maxWidth:1200,margin:"0 auto",width:"100%"}}>
          ...
          <p style={{color:T.muted,fontSize:12,marginBottom:18}}>Mode d'assignation, rÃÂ©ponse IA automatique, rÃÂ¨gles par catÃÂ©gorie</p>
